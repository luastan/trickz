<template>
  <aside class="tricks-nav fancy-scrollbar flex-grow lg:top-16 lg:sticky fixed top-0 left-0 overflow-y-auto lg:relative lg:h-auto max-h-(screen-16) z-30">
    <ul class="category-list lg:sticky lg:top-0 top-0 pl-6 py-6 lg:py-8 lg:pl-0 fancy-scrollbar">
      ...
      >
        ...
        <ul class="sub-category-list">
          <li class="sub-category" v-for="(subCategory, subCategoryIndex) in category.children">
            <nuxt-link
              :to="subCategory.path"
